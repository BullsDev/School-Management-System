...
@section('admin')
    <div class="content-wrapper">
        <div class="container-full">
            ...
            {{-- Top 4 Cards for New Customer, Sold Cras, Sales Lost & Inbound Calls --}}
            <section class="content">
                <div class="row">
                    ...
                    {{-- Next Section to handle last Post Start Here --}}


                    {{-- Next Section to handle New Arrivals Starts Here --}}
                    <div class="col-12">
                        <div class="box">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            {{-- <div class="bg-img h-50 w-50"
                                                                style="background-image: url({{ 'back/images/gallery/creative/img-1.jpg' }})">
                                                            </div> --}}
                                                            <div class="bg-img h-50 w-50"
                                                ...
                                                <td class="pl-0 py-8">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            ...
                                                            <div class="bg-img h-50 w-50"
                                                                style="background-image: url({{ 'backend/images/gallery/creative/img-2.jpg' }})">
                                                            </div>
                                                        </div>
                                                ...
                                                <td class="pl-0 py-8">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            ...
                                                            <div class="bg-img h-50 w-50"
                                                                style="background-image: url({{ 'backend/images/gallery/creative/img-3.jpg' }})">
                                                            </div>
                                                        </div>
                                                ...
                                                <td class="pl-0 py-8">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            ...
                                                            <div class="bg-img h-50 w-50"
                                                                style="background-image: url({{ 'backend/images/gallery/creative/img-4.jpg' }})">
                                                            </div>
                                                        </div>
                                                ...
                                                <td class="pl-0 py-8">
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-shrink-0 mr-20">
                                                            {{-- {{ ('') }} --}}
                                                            <div class="bg-img h-50 w-50"
                                                                style="background-image: url({{ 'backend/images/gallery/creative/img-5.jpg' }})">
                                                            </div>
                                                        </div>
                    ...
                    {{-- Next Section to handle New Arrivals Ends Here --}}
                </div>
            </section>
            <!-- /.content -->
        </div>
